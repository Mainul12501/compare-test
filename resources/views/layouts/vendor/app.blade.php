...
{{--}--}}
    ...
    function getUrlParameter(sParam) {
        ...
        @php($store_type = \App\CentralLogics\Helpers::get_store_data()->store_type)    /*v2.8.1*/
    let order_type = 'all';
    var parcel_order_type = ''; /*v2.8.1*/
    var store_type = '{{$store_type}}'; /*v2.8.1*/
    let is_trip =false;
